...
import { t as __commonJSMin } from "./chunk-D1aRwWSy.js";
//#region node_modules/@stellar/freighter-api/build/index.min.js
var require_index_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(r, e) {
		...
		const n = (r) => {
			...
			if (U) {
				const t = await (async (r, s) => {
					const t = null == s ? void 0 : s.address, o = null == s ? void 0 : s.networkPassphrase;
					let T;
					try {
						T = await n({
							transactionXdr: r,
					...
					const { signedTransaction: A, signerAddress: _ } = T;
					return {
						signedTransaction: A,
						signerAddress: _,
			...
			if (U) {
				...
				const o = await (async (r, s, t) => {
					...
					const { signedBlob: A, signerAddress: _ } = o;
					return {
			...
			if (U) {
				...
				const o = await (async (r, s, t) => {
					...
					const { signedAuthEntry: A, signerAddress: _ } = T;
					return {
